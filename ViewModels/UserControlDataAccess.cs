...
namespace MyDev . ViewModels
{
    ...
    public class UserControlDataAccess
    {
        ...
        public static ObservableCollection<BankAccountViewModel> GetBankObsCollection ( bool NotifyAll , string caller , int max = -1 )
        {
            ...
            {
                Console . WriteLine ( $"Bank loading failed... : {ex . Message} : {ex . Data}" );
            }
            return bcollection;
        }
        ...
        public static bool LoadBankCollection ( ObservableCollection<BankAccountViewModel> bcollection , DataTable dtBank )
        {
            ...
            Console . WriteLine ( $"Data Loaded for: [{Caller}], Records = {bcollection . Count}" );
        ...
        public static Windows . Foundation . IAsyncAction GetBankObsCollectionAsync ( ObservableCollection<BankAccountViewModel> collection , string SqlCommand = "" , bool Notify = false , string Caller = "" )
        {
            ...
            return null as Windows . Foundation . IAsyncAction;
        }
        #endregion BANKACCOUNT Data Access

        #region CUSTOMER Data Access
        public static Windows . Foundation . IAsyncAction GetCustObsCollection ( ObservableCollection<CustomerViewModel> collection , string SqlCommand = "" , bool Notify = false , string Caller = "" )
        {
            //This is a clever variation that uses Dapper and LINQ to load Data via SQL directly into a List<>
            //that is then converted into the requested Obs.Collection directly within this method
            // sort of one stop shop !
            ...
            return cvmcollection as Windows . Foundation . IAsyncAction;
        }
